        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousAssignedToUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketAssignments_AspNetUsers_PreviousAssignedToUserId",
                        column: x => x.PreviousAssignedToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAssignments_IsDeleted",
                table: "TicketAssignments",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_TicketAssignments_PreviousAssignedToUserId",
                table: "TicketAssignments",
                column: "PreviousAssignedToUserId");
